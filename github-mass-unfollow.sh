...
# 🚀 GitHub Mass Unfollow Tool - Standalone Version
# Unfollow users who don't follow you back automatically
# Author: M41k0n-Mk
# Version: 1.0.0
...
echo -e "${PURPLE}"
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║                 🚀 GitHub Mass Unfollow Tool                ║"
echo "║                                                              ║"
echo "║  Clean up your following list by unfollowing users who      ║"
echo "║  don't follow you back automatically and safely.            ║"
echo "║                                                              ║"
echo "║  Author: M41k0n-Mk | Version: 1.0.0                        ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
echo ""
echo -e "${CYAN}📊 Your GitHub Stats:${NC}"
...
# Find non-followers
echo ""
echo -e "${BLUE}🔍 Analyzing your following list...${NC}"
...
if [ "$DRY_RUN" = "true" ]; then
    echo ""
    echo -e "${PURPLE}🔍 DRY RUN MODE: No actual unfollowing will occur${NC}"
    echo -e "${PURPLE}   Would unfollow: ${ACTUAL_UNFOLLOW_COUNT} users${NC}"
    echo ""
    echo -e "${CYAN}To perform actual unfollowing, run without --dry-run flag${NC}"
...
while IFS= read -r user && [ "$PROCESSED" -lt "$ACTUAL_UNFOLLOW_COUNT" ]; do
    ...
    # Rate limiting: GitHub allows 5000 requests per hour, but we're being conservative
    sleep 1
